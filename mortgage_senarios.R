...
# Mortgage details for the amortization schedule function
...
# Scenario 1: Sell current home and buy a larger one
...
# Scenario 2: Keep current home for rent and buy another house
